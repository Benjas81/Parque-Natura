...
// Pano2VR 6.1.2/17873
// Filename: Veracruz Parque Natura.ggsk
// Generated 2026-04-16T22:11:05
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._planta.logicBlock_scaling = function() {
			...
			if (me._planta.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me._planta.ggCurrentLogicStateScaling == 0) {
					me._planta.ggParameter.sx = 0.25;
					me._planta.ggParameter.sy = 0.25;
					...
					me._planta.ggParameter.sx = 0.5;
					me._planta.ggParameter.sy = 0.5;
					me._planta.style[domTransform]=parameterToTransform(me._planta.ggParameter);
				}
			}
		}
		...
		el.ggFilter = [];
		el.ggTagTable = [
			{tag:"JuegosInfantiles",title:"Juegos Infantiles"},
			{tag:"AndadorCanchaUsosMultiples",title:"Andador C. Usos Multiples"},
			{tag:"CanchaUsosMultiples",title:"Cancha Usos Multiples"},
			{tag:"AndadorEntreCanchas",title:"Andador Entre Canchas"},
			{tag:"CanchadeFutbol",title:"Cancha Futbol"},
			{tag:"AndadorCanchadeFutbol",title:"Andador C. Futbol"},
			{tag:"AreadeFitness",title:"\xc1rea Fitness"},
			];
		el.ggId="clone sala";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		els.innerHTML="Parque <br\/>Natura";
		el.appendChild(els);
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		hs='data:image/svg+xml;base64,'+
	...
	function SkinCloner_clone_sala_Class(item, parentScope,ggParent,parameter) {
		...
		me.__div.setAttribute('style','position: absolute;width: 150px; height: 50px; visibility: inherit; overflow: visible;');
